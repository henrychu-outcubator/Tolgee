...
class CustomOpenAiApiService(private val jacksonObjectMapper: ObjectMapper) : AbstractLlmApiService(), Logging {
  ...
  override fun translate(
    ...
    val url = "${config.apiUrl}/v1/chat/completions"
  ...
  /**
   * Data structure for mapping the custom OpenAI-compatible API JSON response objects.
   */
  companion object {
    @Suppress("unused")
    class RequestBody(
